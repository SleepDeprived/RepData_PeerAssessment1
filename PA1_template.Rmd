...
```{r, echo=TRUE}
    ...
    png("daily_step_frequency_na_removed.png", width = 480, height = 480, units="px")
...
The mean number of steps in a day is `r mean_steps` and the median number of steps in a day is `r median_steps`.
...
interval with max average steps is the 5 minute period at `r time_period` with an average of `r period_with_max_ave_steps_step_num` steps
