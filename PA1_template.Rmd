...
The median, mean, and distribution of step numbers per period were examined for the data set as a whole and per day of the week.

```{r, echo=TRUE}
    median(data_na_removed$steps)
    mean(data_na_removed$steps)
